...
<div class="flex min-h-screen">
  ...
  <div class="flex-1 p-4 bg-white">
    ...
    <div class="flex justify-between items-center mb-4">
      <!-- Tombol Tambah User -->
      <a href="/auth/tambahuser" class="inline-block bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
        Tambah User
      </a>
      ...
      <table class="w-full table-auto">
        ...
        <?php foreach ($user as $user): ?>
          <tr class="bg-gray-50 border-b">
            ...
            <td class="px-4 py-2 text-center text-sm text-gray-600"><?= $user['nama_user'] ?></td>
            <td class="px-4 py-2 text-center text-sm text-gray-600"><?= $user['email'] ?></td>
            ...
            <td class="px-4 py-2 text-center text-sm space-x-2">
              <!-- Edit -->
              <a href="/auth/edituser/<?= $user['id_user'] ?>"
...
<script>
  ...
  searchInput.addEventListener("keyup", function () {
    ...
    tableRows.forEach(row => {
      // Cari berdasarkan kolom ke-2 (Username)
