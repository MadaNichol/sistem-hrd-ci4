...
<body class="bg-gray-100">
    <div class="container mx-auto p-6">
        <h1 class="text-2xl font-bold mb-4 text-center">Tambah Role</h1>
        <form action="/simpanrole" method="post" class="bg-white p-6 rounded shadow-md">
        <div class="mb-4">
        ...
        <div class="mb-4">
                ...
                <input type="text" name="role" id="role" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
            </div>
