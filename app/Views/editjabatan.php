...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-xl bg-white p-8 rounded-lg shadow-md">
        <h1 class="text-2xl font-bold text-center text-gray-800 mb-6">Edit Jabatan</h1>

        <form action="/auth/updatejabatan/<?= $jabatann['id_jabatan'] ?>" method="post" class="space-y-4">
            <div>
                <label for="id_jabatan" class="block text-sm font-medium text-gray-700">ID Jabatan</label>
                <input type="text" id="id_jabatan" name="id_jabatan" value="<?= $jabatann['id_jabatan'] ?>" required
            ...
            <div>
                ...
                <input type="text" id="nama_jabatan" name="nama_jabatan" value="<?= $jabatann['nama_jabatan'] ?>" required
                       class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:ring-blue-300">
            </div>

            <div class="flex justify-between items-center">
                <a href="/kelolajabatan"
