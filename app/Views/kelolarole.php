...
<div class="flex min-h-screen">
  ...
  <div class="flex-1 p-4 bg-white">
    <h1 class="text-2xl font-bold mb-4">Kelola Role</h1>
    <p class="mb-8">Welcome, Admin HRD</p>

    <div class="flex justify-between items-center mb-4">
      <!-- Tombol Tambah Role -->
      <a href="/auth/tambahrole" class="inline-block bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
         Tambah Role
      </a>
    ...
    <div class="w-full bg-white shadow rounded-lg overflow-x-auto">
      <table class="w-full table-auto">
        ...
        <tr>
          ...
          <th class="px-4 py-2 text-center text-sm font-semibold text-gray-700">Nama Role</th>
        ...
        <?php foreach ($role as $r): ?>
          <tr class="border-b hover:bg-gray-50">
            <td class="px-4 py-2 text-center text-sm text-gray-600"><?= $r['id_role'] ?></td>
            <td class="px-4 py-2 text-center text-sm text-gray-600"><?= $r['role'] ?></td>
            <td class="px-4 py-2 text-center text-sm space-x-2">
              <a href="/auth/editrole/<?= $r['id_role'] ?>" class="text-yellow-500 hover:text-yellow-600" title="Edit">
                <i class="fas fa-edit text-lg"></i>
              </a>
              <a href="/deleterole/<?= $r['id_role'] ?>"
