...
<div class="flex min-h-screen">
  ...
  <div class="flex-1 p-4 bg-white">
    ...
    <div class="flex justify-between items-center mb-4">
      ...
      <a href="/auth/tambahkategori" class="inline-block bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
        Tambah Kategori
      </a>
      ...
      <table class="w-full table-auto">
        ...
        <?php foreach ($kategori as $kategori): ?>
          <tr class="bg-gray-50 border-b">
            ...
            <td class="px-4 py-2 text-center text-sm text-gray-600"><?= $kategori['kategori_karyawan'] ?></td>
            <td class="px-4 py-2 text-center text-sm space-x-2">
              <!-- Edit -->
                  <a href="/auth/editkategori/<?= $kategori['id_kategori'] ?>"
